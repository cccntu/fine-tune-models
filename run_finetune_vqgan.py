...
## you can load .msgpack to dictionary with:
"""
from flax.serialization import msgpack_restore
with open("{path}.msgpack", "rb") as f:
    x = f.read()
state_dict = msgpack_restore(x)
"""
## you can then replace the original decoder with the trained one, and save it
"""
for k,v in state_dict['params'].items():
    vqgan_params[k] = v
vqgan.save_pretrained("vqgan", params=vqgan_params)
"""
## you can convert it to min-dalle (pytorch) format with:
# https://github.com/kuprel/min-dalle-flax/blob/main/min_dalle_flax/load_params.py
# it's mentioned in the readme of the repo https://github.com/kuprel/min-dalle
